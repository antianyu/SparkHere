...
- (void)updateTimeLabel
{
    ...
    if ([cmp1 day] == [cmp2 day])
    {
        ...
        self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"Last updated：Today %@", time];
    }
    else
    {
        formatter.dateFormat = @"dd/MM/yyyy HH:mm";
        NSString *time = [formatter stringFromDate:self.lastUpdateTime];
        self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"Last updated：%@", time];
    }
}
